          ...
          <div class="row">
            ...
            <div class="col-xl-6 d-none d-lg-block col-lg-5 pb-5 col-md-10 order-1 order-lg-2 position-static">
                <div class="welcome-image-group-wrapper">
                    ...
                    <img  class="w-100 pb-5" src="{{asset('front/image/svg/hero.svg')}}" alt="">
...
{{--
      ...
      {{-- <div class="portfolio-area portfolio-area--l7  border-top bg-default overflow-hidden">
        <div class="container">
          <div class="row align-items-center justify-content-center">
          ...
          <div class="row justify-content-center">
            <div class="col-md-12 col-xs-10">
              <div class="grid grid--l6 position-relative">
                <div class="grid-item grid--3__single customer-support marketing">
                ...
                <div class="grid-item grid--3__single marketing design">
                  <a href="/portfolio-details-3.html" class="portfolio__single">
                ...
                <div class="grid-item grid--3__single customer-support development">
                  <a href="/portfolio-details-3.html" class="portfolio__single">
