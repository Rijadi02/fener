...
<body data-theme-mode-panel-active data-theme="light">
    <div class="site-wrapper overflow-hidden">
        ...
        {{-- Header Start --}}
        <header
            class="site-header site-header--menu-left dynamic-sticky-bg px-3 site-header--absolute site-header--sticky">
            <div class="container-fluid">
                <nav class="navbar site-navbar">
                    ...
                    <div class="menu-block-wrapper  ms-lg-7">
                        ...
                        <nav class="menu-block" id="append-menu-header">
                            ...
                            <ul class="site-menu-main">
                                ...
                                <li class="nav-item sub-menu--item nav-item-has-children">
                                    <a href="{{ route('about') }}" class="nav-link-item ">Rreth Nesh</a>
                                </li>
                                <li class="nav-item sub-menu--item nav-item-has-children">
                                    <a href="{{ route('courses') }}" class="nav-link-item ">Kurset</a>
                                </li>
                                <li class="nav-item sub-menu--item nav-item-has-children">
                                ...
                                <li class="nav-item sub-menu--item nav-item-has-children">
                                    <a href="{{ route('contact') }}" class="nav-link-item ">Kontakti</a>
                                </li>
                    ...
                    <div class="header-btns  ms-auto ms-lg-0 d-none d-sm-flex align-items-center">
                        ...
                        <a class="btn btn-header-btns btn-link-water btn--medium-2 h-45 text-shark rounded-5 ms-1"
                            href="#">
                            Get Started
                        </a>
                    </div>
                        ...
                        <div class="col-lg-3 col-md-7 col-xs-9">
                            <div class="footer-widgets footer-widgets--l7">
                                ...
                                <p class="footer-widgets__text mt-5">
                                    We’re the digital agency to create<br class="d-none d-xl-block"> your digital
                                    presence for better<br class="d-none d-xl-block"> conversion and sales.</p>
                            ...
                            <div class="row">
                                        ...
                                        <ul class="footer-widgets__list footer-widgets--address">
                                            ...
                                            <li>
                                                ...
                                                <a class="heading-default-color gr-text-hover-underline text-break"
                                                    href="mailto:info@medcartel.com">
                                ...
                                <div class="col-md-4 col-xs-9">
                                    <div class="footer-widgets footer-widgets--l7">
                                        ...
                                        <p class="footer-widgets__text mb-4 mt-0">Get the latest trends updates right at
                                            your inbox.</p>
                                        <!-- Newsletter -->
                                        <div class="newsletter newsletter--l7">
                                            <form action="/.">
                                                <input type="text" placeholder="Enter Your Email">
                                                <button class="btn btn-primary shadow--primary-4"
